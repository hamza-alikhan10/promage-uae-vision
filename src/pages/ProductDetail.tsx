...
// Placeholder ImageGallery component (replace with your actual implementation)
const ImageGallery = () => (
  <div className="space-y-4">
    {/* Replace with actual image gallery implementation */}
...
const ProductDetail = () => {
  ...
  const product = {
    ...
    stockCount: 15,
    description:
      'Advanced indoor security camera with pan & tilt functionality, featuring 3MP resolution, AI human detection, and two-way audio communication for comprehensive home monitoring.',
